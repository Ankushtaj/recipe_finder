...
const Header = () => {
    ...
    return (
        <div id='home' className='relative w-full h-[100vh] scroll-mt-16'>
            ...
            <a href='#explore' className='absolute bottom-7 left-1/2'><FaArrowCircleDown className='size-6 sm:size-7 md:size-8 lg:size-9 animate-bounce text-orange-200 opacity-60'/></a>
        </div>
    )
}
